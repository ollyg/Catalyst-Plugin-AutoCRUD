CREATE TABLE location (
    ...
    region varchar(255),
    town varchar(255),
    PRIMARY KEY (country, town)
);

INSERT INTO location (country,region,town) VALUES ('Leeds', 'West Yorkshire', 'England');

INSERT INTO location (country,region,town) VALUES ('Glasgow', '', 'Scotland');

INSERT INTO location (country,region,town) VALUES ('Digby', 'Nova Scotia', 'Canada');

INSERT INTO location (country,region,town) VALUES ('Oxford', 'Oxfordshire', 'England');

INSERT INTO location (country,region,town) VALUES ('Toronto', 'Ontario', 'Canada');

INSERT INTO location (country,region,town) VALUES ('Vancouver', 'B.C.', 'Canada');
...
CREATE TABLE artist (
  ...
  born_town varchar(255),
  home_country varchar(255),
  home_town varchar(255),
  born date,
  FOREIGN KEY (born_country, born_town) REFERENCES location (country, town)
  FOREIGN KEY (home_country, home_town) REFERENCES location (country, town)
);

INSERT INTO artist (id,forename,surname,pseudonym,born_country,born_town,home_country,home_town,born) VALUES (1, 'Mike', 'Smith', 'Alpha Artist', 'Leeds', 'England', 'Leeds', 'England', '1970-02-28');

INSERT INTO artist (id,forename,surname,pseudonym,born_country,born_town,home_country,home_town,born) VALUES (2, 'David', 'Brown', 'Band Beta', 'Digby', 'Canada', 'Vancouver', 'Canada', '1992-05-30');

INSERT INTO artist (id,forename,surname,pseudonym,born_country,born_town,home_country,home_town,born) VALUES (3, 'Adam', 'Smith', 'Gamma Group', 'Glasgow', 'Scotland', 'Oxford', 'England', '1981-05-10');
